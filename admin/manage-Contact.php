...
if (strlen($_SESSION['sturecmsaid']==0)) {
  header('location:logout.php');
   ...
   if (isset($_GET['delid'])) {
    ...
    $sql = "DELETE FROM contact_form WHERE ID = :rid";
    $query = $dbh->prepare($sql);
    $query->bindParam(':rid', $rid, PDO::PARAM_INT);
    if ($query->execute()) {
        echo "<script>alert('Data deleted successfully!');</script>";
        echo "<script>window.location.href = 'manage-Contact.php'</script>";
    } else {
...
<html lang="en">
  <head>
    ...
    <title>Student  Management System|||Manage Enquireies</title>
    <!-- plugins:css -->
    ...
    <div class="container-scroller">
     ...
     <?php include_once('includes/header.php');?>
      ...
      <div class="container-fluid page-body-wrapper">
       ...
       $ret = "SELECT ID FROM contact_form";
...
$sql="SELECT contact_form.ID,contact_form.name,contact_form.email,contact_form.phone,contact_form.message as hwid from contact_form  LIMIT $offset, $no_of_records_per_page";
$query = $dbh -> prepare($sql);
$query->execute();
...
{               ?>   
                          <tr>
                            ...
                            <a href="manage-Contact.php?delid=<?php echo htmlentities($row->ID); ?>"
