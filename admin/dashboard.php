...
?>
                      ...
                      <div class="col-md-4 col-xl report-inner-card">
                        <div class="inner-card-text">
                           <?php 
                        $sql5 ="SELECT * from  contact_form";
$query5 = $dbh -> prepare($sql5);
$query5->execute();
$results5=$query5->fetchAll(PDO::FETCH_OBJ);
$totalcontact=$query5->rowCount();
?>
                          <span class="report-title">Contact Enquireies </span>
                          <h4><?php echo htmlentities($totalcontact);?></h4>
                          <a href="manage-Contact.php"><span class="report-count"> View enquiries</span></a>
                        </div>
                        <div class="inner-card-icon bg-danger">
                      ...
                      <div class="col-md-4 col-xl report-inner-card">
                        <div class="inner-card-text">
                           <?php 
                        $sql6 ="SELECT * from  admissions";
$query6 = $dbh -> prepare($sql6);
$query6->execute();
$results6=$query6->fetchAll(PDO::FETCH_OBJ);
$totaladm=$query6->rowCount();
?>
                          <span class="report-title">Admission Enquireies </span>
                          <h4><?php echo htmlentities($totaladm);?></h4>
                          <a href="manage-Admission.php"><span class="report-count"> Admission enquiries</span></a>
                        </div>
                        <div class="inner-card-icon bg-warning">
